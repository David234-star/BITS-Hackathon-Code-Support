...
void loop() {
  ...
  if(digitalRead(button)==0){
    ...
    bot.sendMessage(ownerid, "Alert from Septic Tank, your tank is going to be full. Clean it before it overflows ", "Markdown");
    bot.sendMessage(municipalid, "Alert from Septic Tank located at Lt: 15.8283837, Lg: 77.588802, it is going to be full","Markdown");
    while(1) {
